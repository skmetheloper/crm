<?php
class OwnerVisibilityGroup
{
    // DB stuff
    private $conn;
    private $table = 'owner_visibility_group';

    // Product Properties
    public $id;
    public $owner_visibility_name;
    public $description;
    ...
    public function read()
    {
        ...
        //                               p.created_at DESC';
        // Create query
        $query = 'SELECT id,owner_visibility_name,description FROM ' . $this->table;
